...
#模型选择
# model = LSTMClassifier(vocab_size, embedding_dim, hidden_dim, output_dim) # 使用 LSTM
# model = RNNClassifier(vocab_size, embedding_dim, hidden_dim, output_dim)  # 使用 RNN
model = GRUClassifier(vocab_size, embedding_dim, hidden_dim, output_dim)  # 使用 GRU
...
# 预测函数 (保持不变，因为所有模型的 forward 输出格式一致)
